...
const projects =[
    ...
    {title: 'Simple Quiz Game', image: '/quiz_game_pic.png', tags: ['HTML', 'Javascript', 'Javascript'], intro: '', vercel: '', github: 'https://github.com/fabrosjhordan-cmd/quiz-game'},

    {title: 'Weather App', image: '/weather_app.png', tags: ['HTML', 'Javascript'], intro: '', vercel: '', github: 'https://github.com/fabrosjhordan-cmd/weatherapp'},

    {title: 'Expense Tracker', image: '/expense_tracker_pic.png', tags: ['HTML', 'Javascript', 'MySQL'], intro: '', vercel: '', github: 'https://github.com/fabrosjhordan-cmd/expensetracker'},
]
